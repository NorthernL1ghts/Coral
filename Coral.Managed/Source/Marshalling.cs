...
public static class Marshalling
{
    ...
    // NOTE: (NorthernL1ghts): This segment performs a crucial operation of copying elements from an input array (InArray) to a buffer.
    // However, it's commented out because it's not currently needed in the implementation.
    ...
    public static object? MarshalPointer(IntPtr InValue, Type InType)
    {
        ...
        // NOTE (NorthernL1ghts): Marshal.PtrToStructure<bool> doesn't seem to work
